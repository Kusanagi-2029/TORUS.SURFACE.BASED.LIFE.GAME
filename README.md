...
> [!CAUTION]
> **_ВЫЕДАЕТСЯ ВСЯ ПАМЯТЬ - переполнение CALL_STACK_:** при размера поля 10000х10000 и размере ячейки **_Canvas 1х1_** при случайности - Тяжеловесной случайности.
> Не выбирать (вкладка переобновиться после нехватки ОЗУ).
