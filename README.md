...
Игра "Жизнь" Джона Конвея с использованием эмуляции Поверхности Тора.
...
> ![image](https://github.com/Kusanagi-2029/TORUS.SURFACE.BASED.LIFE.GAME/assets/71845085/2395b817-7376-483a-88ea-2a7441bfc656)
> После шага, отработка логики жизни и смерти клеток, где розовая - поставленная вручную пользователем, а бирюзовая - сгенерированная автоматически программой по правилам:
> ![image](https://github.com/Kusanagi-2029/TORUS.SURFACE.BASED.LIFE.GAME/assets/71845085/d572f7e4-d864-4ca9-85d8-b3ab9648298e)
...
2. Демо работы **размер поля 5000х5000 и размер ячейки Canvas 1х1** и **размер поля 10000х10000 и размер ячейки Canvas 2х2** при одной и той же случайности - **Тяжеловесной случайности**:
- https://youtu.be/bPMbANaG1VA
> [!CAUTION]
> **_Переполнение CALL_STACK_:** при размере поля 10000х10000 и размере ячейки **_Canvas 1х1_** при Тяжеловесной случайности.
> Не выбирать (вкладка переобновится после нехватки ОЗУ).
...
[Правила игры "Жизнь" № 1](https://ru.wikipedia.org/w/index.php?title=Игра_«Жизнь»&oldid=132904452)
...
> ![image](https://github.com/Kusanagi-2029/TORUS.SURFACE.BASED.LIFE.GAME/assets/71845085/91d76b69-c848-4463-ba7f-1021fdd538b2)
> ![image](https://github.com/Kusanagi-2029/TORUS.SURFACE.BASED.LIFE.GAME/assets/71845085/fdaab6ff-e5c1-4116-b9ef-aca279289341)
> Показатели задействованной памяти виртуальной машиной при максимальной нагрузке находятся в районе 2500 - 3500 мб:
> ![image](https://github.com/Kusanagi-2029/TORUS.SURFACE.BASED.LIFE.GAME/assets/71845085/ad683eaa-c4dc-4e56-ac69-c27a2563bc9c)
